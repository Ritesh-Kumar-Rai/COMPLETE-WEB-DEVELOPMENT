...
-- USE databaseName; to select the db where we will create table
USE startersql;
...
values, useful for financial data. The first number is the total number of digits, and the second is the number of digits after the decimal point.
*/
